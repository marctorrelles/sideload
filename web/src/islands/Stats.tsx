...
export default function Stats() {
  ...
  return <div class="stats" ref={ref}>
    ...
    {s!.matchRate != null && <div><b class="stat c-accent" data-count={Math.round(s!.matchRate * 1000)} data-fmt="pct">0%</b><span class="eyebrow">matched on the first try</span></div>}
    {s!.medianMinutes != null && <div><b class="stat">{s!.medianMinutes} min</b><span class="eyebrow">for a typical library</span></div>}
    <div><b class="stat">$0</b><span class="eyebrow">now and later</span></div>
  </div>;
}
